...
public class CropImageView extends FrameLayout {
    ...
    /**
     * ProgressDialog bar widget to show progress bar on async image loading and cropping.
     */
    ...
    public void saveCroppedImageAsync(Uri saveUri) {
        saveCroppedImageAsync(saveUri, Bitmap.CompressFormat.JPEG, 80, 0, 0, RequestSizeOptions.NONE);
    }
