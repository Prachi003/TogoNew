...
class WelcomeActivityCourier : AppCompatActivity() {
    ...
    val layouts = intArrayOf(
            R.layout.courier_one_layout,
            R.layout.courier_two_layout,
            R.layout.courier_three_layout,
            R.layout.courier_four_layout,
            R.layout.courier_five_layout,
            R.layout.courier_six_layout,
            R.layout.courier_seven_layout)
