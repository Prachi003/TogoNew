...
class CompleteTaskFragment : Fragment() {
    ...
    private fun initilizeView(view: View) {
       ...
       // myTaskList = ArrayList()
        ...
        view.mCmpltTaskReclr.adapter = adpter
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): CompleteTaskFragment {
            val fragment = CompleteTaskFragment()
            val args = Bundle()
    ...
    private fun getMyTaskRequest(view: View) {
        if (Constant.isNetworkAvailable(mContext!!, view.mainLayout)) {
          //  view.progressBar.visibility = View.VISIBLE
            ...
            val stringRequest = object : StringRequest(Request.Method.GET, Constant.BASE_URL + Constant.Get_All_Request_Url+"?userId="+PreferenceConnector.readString(mContext!!, PreferenceConnector.USERID, "")+"&latitude&longitude&status=complete",
               ...
               /* override fun getParams(): Map<String, String> {
                    ...
                    params.put("requestStatus", "complete")
                    params.put("postId", "")
                    return params
                }*/
            }
