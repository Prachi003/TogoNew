package com.togocourier.image.picker;
...
public final class ImagePicker {
    ...
    public static void pickImageFromCamera(Fragment fragment) {
        ...
        if (!appManifestContainsPermission(context, Manifest.permission.CAMERA) || hasCameraAccess(context)){
            ...
            Uri uri = null;
            if (context != null) {
                uri = FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".fileprovider", getTemporalFile(fragment.getContext()));
            }
