package com.togocourier.signaturepad.utils;

import com.togocourier.signaturepad.views.SignaturePad;
...
public final class SignaturePadBindingAdapter {
   ...
   // onSigned
    ...
    // value = {"onStartSigning", "onSigned", "onClear"}, requireAll = false
